...
TukuiBar5:CreatePanel("Invisible", T.buttonsize, (T.buttonsize * 12) + (T.buttonspacing * 11), "RIGHT", UIParent, "RIGHT", -10, -40)
...
local FocusBuffs = CreateFrame("Frame","FilgerFocusBuffs",UIParent)
FocusBuffs:CreatePanel("Default",220, 25, "CENTER", UIParent, "CENTER", -211, -104 )
FocusBuffs:SetMovable(true)
FocusBuffs:SetBackdropBorderColor(1,0,0)
FocusBuffs.text = T.SetFontString(FocusBuffs, C.media.pixelfont, 8, "MONOCHROMEOUTLINE")
FocusBuffs.text:SetPoint("CENTER")
FocusBuffs.text:SetText(hexa.."Move Focus Buffs")
FocusBuffs:Hide()

local PvpPlayerDebuffs = CreateFrame("Frame","FilgerPvpPlayerDebuffs",UIParent)
PvpPlayerDebuffs:CreatePanel("Default",420, 50, "CENTER", UIParent, "CENTER", -250,90 )
...
PvpPlayerDebuffs.text = T.SetFontString(PvpPlayerDebuffs, C.media.pixelfont, 8, "MONOCHROMEOUTLINE")
PvpPlayerDebuffs.text:SetPoint("CENTER")
PvpPlayerDebuffs.text:SetText(hexa.."Move Pvp Player Debuffs")
PvpPlayerDebuffs:Hide()

local PvpTargetDebuffs = CreateFrame("Frame","FilgerPvpTargetDebuffs",UIParent)
PvpTargetDebuffs:CreatePanel("Default",420, 50,"CENTER", UIParent, "CENTER", 250,180)
...
PvpTargetDebuffs.text = T.SetFontString(PvpTargetDebuffs, C.media.pixelfont, 8, "MONOCHROMEOUTLINE")
PvpTargetDebuffs.text:SetPoint("CENTER")
PvpTargetDebuffs.text:SetText(hexa.."Move Pvp Target Debuffs")
PvpTargetDebuffs:Hide()

local BossDebuffs = CreateFrame("Frame","FilgerBossDebuffs",UIParent)
BossDebuffs:CreatePanel("Default",150, 35, "CENTER", UIParent, "CENTER", -400, 20)
BossDebuffs:SetMovable(true)
BossDebuffs:SetBackdropBorderColor(1,0,0)
BossDebuffs:SetFrameLevel(2)
BossDebuffs:SetFrameStrata("HIGH")
BossDebuffs.text = T.SetFontString(FilgerBossDebuffs, C.media.pixelfont, 8, "MONOCHROMEOUTLINE")
BossDebuffs.text:SetPoint("CENTER")
BossDebuffs.text:SetText(hexa.."Move Boss Debuffs")
BossDebuffs:Hide()