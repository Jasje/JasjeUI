...
if not C["datatext"].friends or C["datatext"].friends == 0 then return end
	...
	local friendMenuList = {
		...
		{ text = hexa.."Invite"..hexb, hasArrow = true,notCheckable=true,
			menuList = {
				{ text = hexa.."Option 3"..hexb, func = function() print("You've chosen option 3"); end }
			}
		},
		{ text = hexa.."Whisper"..hexb, hasArrow = true,notCheckable=true,
			menuList = {
				{ text = hexa.."Option 4"..hexb, func = function() print("You've chosen option 4"); end }
			}
		},
		{ text = hexa.."Sort"..hexb, hasArrow = true,notCheckable=true,
			menuList = {
				{ notCheckable=true,text = "Name", func = setFriendSort, arg1=sortName},
				{ notCheckable=true,text = "Zone", func = setFriendSort, arg1=sortZone},
			}
		},
		{ text = hexa.."Battle.Net"..hexb, hasArrow = true,notCheckable=true,
			menuList = {
				{ text = hexa.."Set Broadcast"..hexb, notCheckable=true, func = function()
					friendMenuFrame:Hide()
