	...
	if addon == "Tukui" then
			...
			local function Channel()
				for i=1, MAX_DISPLAY_CHANNEL_BUTTONS do
					...
					if button then
						...
						_G["ChannelButton"..i.."Text"]:SetFont(FONT, 8, FONTFLAG)
					end
				end
			end
		...
		do
			...
			for i = 1, getn(interfacedropdown) do
				...
				if idropdown then
					SkinDropDownBox(idropdown)
					DropDownList1:SetTemplate("Default")
				end
			end
			SkinButton(InterfaceOptionsHelpPanelResetTutorials)
