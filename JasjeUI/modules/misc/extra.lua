...
-- raidwarningtext
RaidWarningFrameSlot1:SetTextColor(1,1,1)
RaidWarningFrameSlot2:SetTextColor(1,1,1)

RaidWarningFrame:ClearAllPoints() 
RaidWarningFrame:SetPoint("CENTER", UIParent, "CENTER",0, 290)

--------------------------------------
-- Addon manager by Asphyxia
--------------------------------------
...
addonBG:CreatePanel("Transparent", T.InfoLeftRightWidth, 400, "CENTER", UIParent, "CENTER", 0, 0)
...
scrollFrame:SetPoint("BOTTOMRIGHT", addonBG, "BOTTOMRIGHT", -34, 40)
...
saveButton:CreatePanel("Transparent", 130, 20, "BOTTOMLEFT", addonBG, "BOTTOMLEFT", 10, 10, true)
...
saveButton.text:SetText("|cffD38D01Save Changes")
...
closeButton:CreatePanel("Transparent", 130, 20, "BOTTOMRIGHT", addonBG, "BOTTOMRIGHT", -10, 10, true)
...
closeButton.text:SetText("|cffD38D01Cancel")
...
local function UpdateAddons()
	...
	for i,v in pairs(addons) do
		...
		local text = T.SetFontString(button, font, fontsize, fontstyle)
